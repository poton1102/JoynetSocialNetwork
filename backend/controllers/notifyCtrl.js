...
const notifyCtrl = {
    createNotify: async (req, res) => {
        try {
            ...
            //chặn thông báo khi chủ post like bài của chính nó
    ...
    //khi createNotify, sẽ lấy những người trong recipients
    ...
    isReadNotify: async (req, res) => {
        try {
            ...
            const notifies = await Notifies.findOneAndUpdate(
                { _id: req.params.id, recipients: req.user._id }, // only update the notification for the current user
                { isRead: true },
